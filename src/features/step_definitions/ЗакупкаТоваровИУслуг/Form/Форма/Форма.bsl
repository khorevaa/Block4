...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯЗагрузилНоменклатуруИзФикстуры()","ЯЗагрузилНоменклатуруИзФикстуры","Допустим Я загрузил Номенклатуру из фикстуры");
...
&НаКлиенте
//Допустим Я загрузил Номенклатуру из фикстуры
//@ЯЗагрузилНоменклатуруИзФикстуры()
Процедура ЯЗагрузилНоменклатуруИзФикстуры() Экспорт
