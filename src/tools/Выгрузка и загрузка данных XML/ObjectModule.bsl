...
Функция МенеджерОбъектаПоПолномуИмени(ПолноеИмя)
	...
	Если ВРег(КлассОМ) = ВернутьЗначениеСоответствия("СПРАВОЧНИК") Тогда
		Менеджер = Справочники;
	ИначеЕсли ВРег(КлассОМ) = ВернутьЗначениеСоответствия("документ") Тогда
		Менеджер = Документы;
	ИначеЕсли ВРег(КлассОМ) = ВернутьЗначениеСоответствия("ПЛАНВИДОВХАРАКТЕРИСТИК") Тогда
		Менеджер = ПланыВидовХарактеристик;
	ИначеЕсли ВРег(КлассОМ) = ВернутьЗначениеСоответствия("ПЛАНСЧЕТОВ") Тогда
		Менеджер = ПланыСчетов;
	ИначеЕсли ВРег(КлассОМ) = ВернутьЗначениеСоответствия("ПЛАНВИДОВРАСЧЕТА") Тогда
...
Функция ВернутьЗначениеСоответствия(ИскомоеЗначение)
	...
	Если ВариантВстроенногоЯзыкаАнглийский Тогда
		ЭлементСоответствия = АнглийскоеСоответствие.Получить(ВРег(ИскомоеЗначение));
		Если НЕ ЭлементСоответствия = Неопределено Тогда
			ЗначениеСоответствия = ЭлементСоответствия
		КонецЕсли; 
	КонецЕсли; 
	Возврат ВРег(ЗначениеСоответствия);
КонецФункции
